...
// Both images are re-hosted on imgbb first, because fal needs stable, fetchable
// URLs: her photo arrives as base64 (too big to pass raw) and garment links are
// often hotlink-protected. Env: FAL_KEY (required), IMGBB_KEY (required).
export default async function handler(req, res) {
  ...
  try {
    ...
    // Host both on imgbb so fal can reliably fetch them.
